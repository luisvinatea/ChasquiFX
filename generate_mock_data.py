...
airports_data = {
    "iata_code": [
        "JFK", "LHR", "CDG", "SFO", "NRT", "MEX", "SYD", "GRU", "DXB", "PEK",
        "BKK", "AMS", "MAD", "SIN", "LAX", "MIA", "YVR", "FCO", "MUC", "ZRH"
    ],
    "name": [
        "John F. Kennedy International Airport", "London Heathrow Airport",
        "Charles de Gaulle Airport", "San Francisco International Airport",
        "Narita International Airport", "Mexico City International Airport",
        "Sydney Airport", "São Paulo–Guarulhos International Airport",
        "Dubai International Airport", "Beijing Capital International Airport",
        "Suvarnabhumi Airport", "Amsterdam Airport Schiphol",
        ...
        "Munich Airport", "Zurich Airport"
    ],
    "city": [
        "New York", "London", "Paris", "San Francisco", "Tokyo", "Mexico City",
        "Sydney", "São Paulo", "Dubai", "Beijing", "Bangkok", "Amsterdam",
        "Madrid", "Singapore", "Los Angeles", "Miami", "Vancouver", "Rome",
        "Munich", "Zurich"
    ],
    "country": [
        "United States", "United Kingdom", "France", "United States", "Japan",
        "Mexico", "Australia", "Brazil", "United Arab Emirates", "China",
        "Thailand", "Netherlands", "Spain", "Singapore", "United States",
        "United States", "Canada", "Italy", "Germany", "Switzerland"
    ],
    "latitude": [
        40.641766, 51.4700, 49.0097, 37.6213, 35.7647, 19.4363, -33.9499,
        -23.4356, 25.2528, 40.0799, 13.6811, 52.3086, 40.4983, 1.3644,
        33.9416, 25.7932, 49.1951, 41.8003, 48.3538, 47.4647
    ],
    "longitude": [
        -73.778925, -0.4543, 2.5479, -122.3790, 140.3864, -99.0721, 151.1819,
        -46.4731, 55.3644, 116.6031, 100.7473, 4.7639, -3.5676, 103.9915,
        -118.4085, -80.2906, -123.1785, 12.2389, 11.7861, 8.5554
    ],
    "currency": [
        "USD", "GBP", "EUR", "USD", "JPY", "MXN", "AUD", "BRL", "AED", "CNY",
        "THB", "EUR", "EUR", "SGD", "USD", "USD", "CAD", "EUR", "EUR", "CHF"
    ]
}
...
for i, origin in enumerate(airports_data["iata_code"]):
    ...
    destinations = np.random.choice(
        ...
        size=num_destinations, replace=False
    )
...
currencies = ["USD", "EUR", "GBP", "JPY", "AUD", "CAD", "CHF", "CNY", "MXN", "BRL", "SGD", "AED", "THB"]
base_currency = "USD"
