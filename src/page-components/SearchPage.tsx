  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Find the best flight deals with forex advantages</p>
      </div>

      <div className="grid lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <SearchForm onSearch={handleSearch} onCurrencyChange={handleCurrencyChange} />
        </div>
